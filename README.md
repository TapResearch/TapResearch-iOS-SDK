# TapResearch-iOS-SDK
TapResearch iOS SDK v3.1.0-beta4-15
...
> [!WARNING]
> This version is for use with Xcode 15, for Xcode 14 please use **v3.1.0-beta4-14**.
...
* Set the version value to 3.1.0-beta4-15
...
Add the pod info to the app's Podfile
 ```ruby
 pod 'TapResearch', '3.1.0-beta4-15'
 ```
